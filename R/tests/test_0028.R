...
num_groups <- 20
colour_vec <- c(
  "#9A275A", "#F5BB00", "#F04419", "#F35371", "#59C9A5")
...
diags <- tibble::tibble(
  y = rep(diags_x_start, times = num_diag_lines),
  x = seq(-3, 15, length.out = num_diag_lines),
  yend = seq(diags_x_start + 2, 15, length.out = num_diag_lines),
  xend = seq(15, 1, length.out = num_diag_lines))
