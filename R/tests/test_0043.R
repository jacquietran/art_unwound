...
iteration_id <- "test_0043"
initial_seed <- 2
num_groups <- 10
num_tiles <- 10 # number produces a square, e.g., 5x5
colour_vec <- c(
  "#345e6a", "#a63a52", "#ea6c81", "#f39597", "#e2782c", "#f7a54d", "#f6e488")
...
p <- ggplot() +
  ...
  theme(
    ...
    plot.background = element_rect(fill = "#f3e1dd", colour = "#f3e1dd"),
